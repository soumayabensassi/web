...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index0.php">Concept</a>
    ...
    <div class="dashboard-wrapper">
        <div class="dashboard-ecommerce">
            ...
            <input type="radio" name="radio-inline" checked="" class="custom-control-input"><span class="custom-control-label">non déliveré</span>
        </label>
                                                        <label class="custom-control custom-radio custom-control-inline">
            <input type="radio" name="radio-inline" class="custom-control-input"><span class="custom-control-label">déliveré</span>
        </label></td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    ...
                                                    <td>
                                                        <label class="custom-control custom-radio custom-control-inline">
            <input type="radio" name="radio-inline1" checked="" class="custom-control-input"><span class="custom-control-label">non déliveré</span>
        </label>
                                                        <label class="custom-control custom-radio custom-control-inline">
            <input type="radio" name="radio-inline1" class="custom-control-input"><span class="custom-control-label">déliveré</span>
        </label></td>
                                                </tr>
                                                <tr>
                                                    <td>3</td>
                                                    ...
                                                    <td>
                                                        <label class="custom-control custom-radio custom-control-inline">
            <input type="radio" name="radio-inline2" checked="" class="custom-control-input"><span class="custom-control-label">non déliveré</span>
        </label>
                                                        <label class="custom-control custom-radio custom-control-inline">
            <input type="radio" name="radio-inline2" class="custom-control-input"><span class="custom-control-label">déliveré</span>
        </label></td>
                                                </tr>
                                                <tr>
                                                    <td>4</td>
                                                    ...
                                                    <td>
                                                        <label class="custom-control custom-radio custom-control-inline">
            <input type="radio" name="radio-inline3" checked="" class="custom-control-input"><span class="custom-control-label">non déliveré</span>
        </label>
                                                        <label class="custom-control custom-radio custom-control-inline">
            <input type="radio" name="radio-inline3" class="custom-control-input"><span class="custom-control-label">déliveré</span>
        </label></td>
                                                </tr>
                                                <tr>
