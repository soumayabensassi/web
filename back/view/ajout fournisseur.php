...
<body>
    ...
    <!-- signup form  -->
    <!-- ============================================================== -->
    <form class="splash-container" action="ajouterfournisseur.php" method="POST">
        <div class="card">
            ...
            <div class="form-group">
                    <input class="form-control form-control-lg" type="text" name="nomfournisseur" required="" placeholder="nom fournisseur" autocomplete="off">
                </div>
                <div class="form-group">
